		...
		<div class="inner_content">
			...
			<div class="mt-3 mb-3" style="text-align: left;font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size: 15px;font-weight: bold;">
				...
				<div class="btn-group" role="group" aria-label="Basic example">
					...
					<a type="button" class="btn btn-primary" href="./employee_del.php?bookstore_id=<?php echo $_GET["bookstore_id"]; ?>">刪除</a>
					<a type="button" class="btn btn-primary" href="./employee_edit.php?bookstore_id=<?php echo $_GET["bookstore_id"]; ?>">修改</a>
				</div>
			</div>
