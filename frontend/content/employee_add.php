	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				...
				<a class="nav-item nav-link active" href="employee.php?bookstore_id=<?php echo $_GET["bookstore_id"] ?>">編輯書店<span class="sr-only">(current)</span></a>
			</div>
		</div>
	</nav>
	<form method="get" action="employee_addsave.php" enctype="multipart/form-data">
		<div class="content">
